...
export default function CartPage() {
  ...
  return (
    <div style={{ maxWidth: "1000px", margin: "0 auto", padding: "2.5rem 1.5rem", minHeight: "70vh" }}>
      ...
      <div style={{
        ...
        <span style={{
          ...
          letterSpacing: "0.1em",
          color: "#888"
        }}>{cartItems.length} {cartItems.length === 1 ? "Item" : "Items"}</span>
      </div>
      ...
      {cartItems.length === 0 ? (
        <div style={{
          ...
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none"
            stroke="#ccc" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"
          ...
          <p style={{
            ...
            color: "#aaa",
            marginBottom: "2.5rem"
          }}>Add something beautiful to get started</p>
          <Link href="/" style={{
            fontSize: "10px",
            letterSpacing: "0.2em",
            textTransform: "uppercase",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
              ...
              <span style={{ fontSize: "12px", color: "#ccc" }}>${totalPrice.toFixed(2)}</span>
            </div>
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1.5rem" }}>
              <span style={{ fontSize: "12px", color: "#666" }}>Shipping</span>
              <span style={{ fontSize: "12px", color: "#fff", fontWeight: 500 }}>Free</span>
            </div>
            <div style={{
              display: "flex",
              justifyContent: "space-between",
              ...
              <span style={{ fontSize: "14px", fontWeight: 500, color: "#fff" }}>Total</span>
              <span style={{ fontSize: "14px", fontWeight: 500, color: "#fff" }}>${totalPrice.toFixed(2)}</span>
            </div>
